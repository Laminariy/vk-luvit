...
local VKRequest = Class{}

  --- Create VKRequest object
  -- @param token (string|table) token or list of tokens
  -- @param version (string|nil) api version
  -- @return VKRequest object
  function VKRequest:init(token, version)
    self.token = TokenGenerator(token)
  ...
  function VKRequest:request(method, params)
